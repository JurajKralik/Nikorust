...
pub fn army_step(bot: &mut Nikolaj) {
    ...
    for unit in &units {
        match unit.type_id() {
            UnitTypeId::Marine => {
                marine_control(bot, unit);
            }
            UnitTypeId::Marauder => {
                marauder_control(bot, unit);
            }
            UnitTypeId::Reaper => {
                reaper_control(bot, unit);
            }
            UnitTypeId::Ghost => {
                ghost_control(bot, unit);
            }
            UnitTypeId::Hellion | UnitTypeId::HellionTank => {
                hellion_control(bot, unit);
            }
            UnitTypeId::SiegeTank | UnitTypeId::SiegeTankSieged => {
                tank_control(bot, unit);
            }
            UnitTypeId::WidowMine | UnitTypeId::WidowMineBurrowed => {
                widowmine_control(bot, unit);
            }
            UnitTypeId::Cyclone => {
            ...
            UnitTypeId::VikingFighter | UnitTypeId::VikingAssault => {
                viking_control(bot, unit);
            }
            UnitTypeId::Medivac => {
                medivac_control(bot, unit);
            }
            UnitTypeId::Raven => {
                raven_control(bot, unit);
            }
            UnitTypeId::Banshee => {
                banshee_control(bot, unit);
            }
